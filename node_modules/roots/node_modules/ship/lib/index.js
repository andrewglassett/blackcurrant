...
(function() {
  var Ship, W, fs, nodefn, path, prompt, yaml, _;
  ...
  Ship = (function() {
    ...
    Ship.prototype.configure = function(data) {
      var config_keys, _ref;
      config_keys = (_ref = this.deployer.config) != null ? _ref.required : void 0;
    ...
    Ship.prototype.config_prompt = function() {
      var _ref;
      return prompt(this.deployer_name, (_ref = this.deployer.config) != null ? _ref.required : void 0).tap((function(_this) {
        return function(res) {
